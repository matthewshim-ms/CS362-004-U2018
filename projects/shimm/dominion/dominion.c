...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  // **BUG FIX - moved drawntreasure to card adventurer method
  // int drawntreasure=0;
  
  // **BUG FIX - variable (cardDrawn) no longer in use, deleted
  // int cardDrawn;
  int z = 0;// this is the counter for the temp hand

  int check_if_embargo;
  ...
  switch( card ) 
    {
    case adventurer:
      Card_adventurer(currentPlayer, temphand, z, state);
      return 0;
    ...
    case smithy:
      Card_smithy(currentPlayer, handPos, state);
      return 0;
		
    case village:
      Card_village(currentPlayer, handPos, state);
      return 0;
    ...
    case steward:
      Card_steward(currentPlayer, handPos, choice1, choice2, choice3, state);
      return 0;
    ...
    case embargo: 
      check_if_embargo = Card_embargo(choice1, handPos, currentPlayer, state);
      return check_if_embargo;
